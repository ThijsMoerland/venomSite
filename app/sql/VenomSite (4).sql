...
--
-- Host: mysql
-- Generation Time: Nov 04, 2023 at 06:53 PM
...
(1, 'root', '$2y$10$Q5UeMshGUGBQa24jXd4OG.NsoNS4/qp2hBpacewijUYLq2n0NUsk2');

-- --------------------------------------------------------

--
-- Table structure for table `classOrderIds`
--

CREATE TABLE `classOrderIds` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `classOrderIds`
--

INSERT INTO `classOrderIds` (`id`, `classId`, `orderId`) VALUES
(1, 1, 1),
(2, 1, 2);
...
INSERT INTO `classTypes` (`id`, `classType`, `classCommonName`, `shortDescription`, `description`, `imgURL`) VALUES
(1, 'Reptilia', 'Reptiles', 'The reptilia class is also known as reptiles and consists of 4 orders 1. Squamata which are the lizards and snake 2. Crocodilia which are the crocodilians 3. Testudines  which are the turtles and 4. Rhynchocephalia which consists only the tuatara family', 'Reptiles, in common parlance, are a group of tetrapods with an ectothermic (&#039;cold-blooded&#039;) metabolism and amniotic development. Living reptiles comprise of four orders: Testudines (turtles), Crocodilia (crocodilians), Squamata (lizards and snakes), and Rhynchocephalia (the tuatara)', 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/43/Reptiles_2021_collage.jpg/450px-Reptiles_2021_collage.jpg');
...
INSERT INTO `orderTypes` (`id`, `orderType`, `orderName`, `shortDescription`, `description`, `imgURL`) VALUES
(1, 'Squamata', 'Lizards and snakes', 'The squamata order consists of lizards and snakes which devide into 2 suborders serpentes and lacertilia. these animals are found on every continent except for antartica', 'The squamata order consists of lizards and snakes which devide into 2 suborders serpentes and lacertilia. these animals are found on every continent except for antartica', 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Squamata-01.jpg/1280px-Squamata-01.jpg'),
(2, 'Crocodilia', 'Crocodilians', 'The crocodilia order consists of all the known crocodile species, and they are found in all continents except for Antarctica and Europe. They are quite large with some reaching 6 meters in length.', 'The crocodilia order consists of all the known crocodile species, and they are found in all continents except for Antarctica and Europe. They are quite large with some reaching 6 meters in length.', 'https://dr282zn36sxxg.cloudfront.net/datastreams/f-d%3Afabbf9109c9d7950c52fd754d814c1868b06dd8508d5d5b355204e95%2BIMAGE_TINY%2BIMAGE_TINY.1');
...
--
-- Indexes for table `classOrderIds`
--
ALTER TABLE `classOrderIds`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `classOrderIds`
--
ALTER TABLE `classOrderIds`
